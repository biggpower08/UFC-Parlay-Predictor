...
| finish_in_round_1_model | weak_or_failed_baseline | 3683 | 0.6516 | 0.6127 | 0.6735 | 0.2189 | 0.7613 | -0.1097 |
| finish_type_model | weak_or_failed_baseline | 1796 | 0.559 | 0.44 | None | None | 0.632 | -0.073 |
...
| finish_type_model | weak_or_failed_baseline | 1796 | 0.559 | 0.632 | -0.073 | False | Does not beat majority-class baseline on final chronological test set.; Balanced accuracy is weak; keep as experimental context.; Conditional model: trained and scored only on fights that actually finished. |
| finish_in_round_1_model | weak_or_failed_baseline | 3683 | 0.6516 | 0.7613 | -0.1097 | False | Does not beat majority-class baseline on final chronological test set. |
...
- weight_class:Bantamweight: {'rows': 291, 'accuracy': 0.7801}
- weight_class:Bantamweight Bout: {'rows': 131, 'accuracy': 0.771}
- weight_class:Featherweight: {'rows': 295, 'accuracy': 0.5695}
- weight_class:Featherweight Bout: {'rows': 129, 'accuracy': 0.5271}
- weight_class:Flyweight: {'rows': 201, 'accuracy': 0.6219}
- weight_class:Flyweight Bout: {'rows': 91, 'accuracy': 0.5714}
- weight_class:Heavyweight: {'rows': 174, 'accuracy': 0.6092}
- weight_class:Heavyweight Bout: {'rows': 73, 'accuracy': 0.6712}
- weight_class:Light Heavyweight: {'rows': 174, 'accuracy': 0.5517}
- weight_class:Light Heavyweight Bout: {'rows': 76, 'accuracy': 0.5395}
- weight_class:Lightweight: {'rows': 332, 'accuracy': 0.6446}
- weight_class:Lightweight Bout: {'rows': 148, 'accuracy': 0.6284}
- weight_class:Middleweight: {'rows': 322, 'accuracy': 0.5714}
- weight_class:Middleweight Bout: {'rows': 145, 'accuracy': 0.5517}
- weight_class:Welterweight: {'rows': 287, 'accuracy': 0.6341}
- weight_class:Welterweight Bout: {'rows': 132, 'accuracy': 0.5833}
- weight_class:Women's Bantamweight: {'rows': 104, 'accuracy': 0.7212}
- weight_class:Women's Flyweight: {'rows': 121, 'accuracy': 0.7521}
- weight_class:Women's Flyweight Bout: {'rows': 54, 'accuracy': 0.7593}
- weight_class:Women's Strawweight: {'rows': 161, 'accuracy': 0.8944}
- weight_class:Women's Strawweight Bout: {'rows': 71, 'accuracy': 0.9014}
- enough_fighter_history: {'rows': 3209, 'accuracy': 0.6516}
- low_fighter_history: {'rows': 474, 'accuracy': 0.6519}
### finish_type_model
- weight_class:Bantamweight: {'rows': 91, 'accuracy': 0.3846}
- weight_class:Featherweight: {'rows': 164, 'accuracy': 0.5305}
- weight_class:Featherweight Bout: {'rows': 71, 'accuracy': 0.5775}
- weight_class:Flyweight: {'rows': 97, 'accuracy': 0.5258}
- weight_class:Heavyweight: {'rows': 90, 'accuracy': 0.5444}
- weight_class:Light Heavyweight: {'rows': 117, 'accuracy': 0.6752}
- weight_class:Lightweight: {'rows': 174, 'accuracy': 0.5517}
- weight_class:Lightweight Bout: {'rows': 75, 'accuracy': 0.6533}
- weight_class:Middleweight: {'rows': 189, 'accuracy': 0.5397}
- weight_class:Middleweight Bout: {'rows': 87, 'accuracy': 0.5862}
- weight_class:Welterweight: {'rows': 159, 'accuracy': 0.6792}
- weight_class:Welterweight Bout: {'rows': 76, 'accuracy': 0.6711}
- weight_class:Women's Strawweight: {'rows': 51, 'accuracy': 0.2941}
- enough_fighter_history: {'rows': 1524, 'accuracy': 0.5682}
- low_fighter_history: {'rows': 272, 'accuracy': 0.5074}
...
| finish_in_round_1_model | >=80% | 253 | 6.87 | 0.7747 | 0.7145 | 0.8423 | 0.0676 | False | False |
| finish_type_model | >=80% | 418 | 23.27 | 0.61 | 0.557 | 0.8876 | 0.2776 | False | False |
