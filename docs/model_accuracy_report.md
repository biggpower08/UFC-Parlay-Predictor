...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| fight_duration_model | evaluated | 3696 | 0.8312 | 0.8322 | 0.8984 | 0.1296 | 0.5141 | 0.3171 |
...
| finish_in_round_1_model | weak_or_failed_baseline | 3683 | 0.6565 | 0.626 | 0.6853 | 0.2177 | 0.7613 | -0.1048 |
| finish_type_model | weak_or_failed_baseline | 1796 | 0.5607 | 0.4307 | None | None | 0.632 | -0.0713 |
...
| fight_duration_model | evaluated | 3696 | 0.8312 | 0.5141 | 0.3171 | True |  |
| finish_model | evaluated | 3696 | 0.8312 | 0.5141 | 0.3171 | True | Compatibility output: internally backed by fight_duration_model. |
| goes_distance_model | evaluated | 3696 | 0.8312 | 0.5141 | 0.3171 | True | Compatibility output: goes_distance_probability is derived as 1 - finish_probability. |
...
| strike_volume_model | evaluated | 1322 | 0.447 | 0.3623 | 0.0847 | True | Balanced accuracy is weak; keep as experimental context. |
...
| finish_type_model | weak_or_failed_baseline | 1796 | 0.5607 | 0.632 | -0.0713 | False | Does not beat majority-class baseline on final chronological test set.; Balanced accuracy is weak; keep as experimental context.; Conditional model: trained and scored only on fights that actually finished. |
| finish_in_round_1_model | weak_or_failed_baseline | 3683 | 0.6565 | 0.7613 | -0.1048 | False | Does not beat majority-class baseline on final chronological test set. |
...
- weight_class:Bantamweight: {'rows': 292, 'accuracy': 0.8562}
- weight_class:Bantamweight Bout: {'rows': 131, 'accuracy': 0.8702}
- weight_class:Featherweight: {'rows': 297, 'accuracy': 0.8519}
- weight_class:Featherweight Bout: {'rows': 129, 'accuracy': 0.8605}
- weight_class:Flyweight: {'rows': 202, 'accuracy': 0.8366}
- weight_class:Flyweight Bout: {'rows': 91, 'accuracy': 0.8242}
- weight_class:Heavyweight: {'rows': 175, 'accuracy': 0.7486}
- weight_class:Heavyweight Bout: {'rows': 73, 'accuracy': 0.7397}
- weight_class:Light Heavyweight: {'rows': 175, 'accuracy': 0.8457}
- weight_class:Light Heavyweight Bout: {'rows': 76, 'accuracy': 0.8816}
- weight_class:Lightweight: {'rows': 335, 'accuracy': 0.8149}
- weight_class:Lightweight Bout: {'rows': 148, 'accuracy': 0.8581}
- weight_class:Middleweight: {'rows': 323, 'accuracy': 0.805}
- weight_class:Middleweight Bout: {'rows': 145, 'accuracy': 0.8759}
- weight_class:Welterweight: {'rows': 287, 'accuracy': 0.8084}
- weight_class:Welterweight Bout: {'rows': 132, 'accuracy': 0.803}
- weight_class:Women's Bantamweight: {'rows': 105, 'accuracy': 0.8952}
- weight_class:Women's Flyweight: {'rows': 122, 'accuracy': 0.8361}
- weight_class:Women's Flyweight Bout: {'rows': 54, 'accuracy': 0.8519}
- weight_class:Women's Strawweight: {'rows': 162, 'accuracy': 0.784}
- weight_class:Women's Strawweight Bout: {'rows': 71, 'accuracy': 0.8451}
- enough_fighter_history: {'rows': 3219, 'accuracy': 0.8245}
- low_fighter_history: {'rows': 477, 'accuracy': 0.8763}
### over_1_5_model
...
- weight_class:Bantamweight: {'rows': 291, 'accuracy': 0.7526}
- weight_class:Bantamweight Bout: {'rows': 131, 'accuracy': 0.7252}
- weight_class:Featherweight: {'rows': 295, 'accuracy': 0.5864}
- weight_class:Featherweight Bout: {'rows': 129, 'accuracy': 0.5194}
- weight_class:Flyweight: {'rows': 201, 'accuracy': 0.6866}
- weight_class:Flyweight Bout: {'rows': 91, 'accuracy': 0.6374}
- weight_class:Heavyweight: {'rows': 174, 'accuracy': 0.6264}
- weight_class:Heavyweight Bout: {'rows': 73, 'accuracy': 0.6164}
- weight_class:Light Heavyweight: {'rows': 174, 'accuracy': 0.6034}
- weight_class:Light Heavyweight Bout: {'rows': 76, 'accuracy': 0.5658}
- weight_class:Lightweight: {'rows': 332, 'accuracy': 0.6777}
- weight_class:Lightweight Bout: {'rows': 148, 'accuracy': 0.6284}
- weight_class:Middleweight: {'rows': 322, 'accuracy': 0.5435}
- weight_class:Middleweight Bout: {'rows': 145, 'accuracy': 0.5379}
- weight_class:Welterweight: {'rows': 287, 'accuracy': 0.6341}
- weight_class:Welterweight Bout: {'rows': 132, 'accuracy': 0.6061}
- weight_class:Women's Bantamweight: {'rows': 104, 'accuracy': 0.7404}
- weight_class:Women's Flyweight: {'rows': 121, 'accuracy': 0.7603}
- weight_class:Women's Flyweight Bout: {'rows': 54, 'accuracy': 0.7593}
- weight_class:Women's Strawweight: {'rows': 161, 'accuracy': 0.8634}
- weight_class:Women's Strawweight Bout: {'rows': 71, 'accuracy': 0.8592}
- enough_fighter_history: {'rows': 3209, 'accuracy': 0.6563}
- low_fighter_history: {'rows': 474, 'accuracy': 0.6582}
### finish_type_model
- weight_class:Bantamweight: {'rows': 91, 'accuracy': 0.3407}
- weight_class:Featherweight: {'rows': 164, 'accuracy': 0.5122}
- weight_class:Featherweight Bout: {'rows': 71, 'accuracy': 0.5211}
- weight_class:Flyweight: {'rows': 97, 'accuracy': 0.567}
- weight_class:Heavyweight: {'rows': 90, 'accuracy': 0.5889}
- weight_class:Light Heavyweight: {'rows': 117, 'accuracy': 0.6752}
- weight_class:Lightweight: {'rows': 174, 'accuracy': 0.5517}
- weight_class:Lightweight Bout: {'rows': 75, 'accuracy': 0.6267}
- weight_class:Middleweight: {'rows': 189, 'accuracy': 0.5608}
- weight_class:Middleweight Bout: {'rows': 87, 'accuracy': 0.6092}
- weight_class:Welterweight: {'rows': 159, 'accuracy': 0.673}
- weight_class:Welterweight Bout: {'rows': 76, 'accuracy': 0.6316}
- weight_class:Women's Strawweight: {'rows': 51, 'accuracy': 0.3725}
- enough_fighter_history: {'rows': 1524, 'accuracy': 0.5696}
- low_fighter_history: {'rows': 272, 'accuracy': 0.511}
...
### strike_volume_model
- weight_class:Bantamweight: {'rows': 150, 'accuracy': 0.4867}
- weight_class:Featherweight: {'rows': 152, 'accuracy': 0.5}
- weight_class:Flyweight: {'rows': 103, 'accuracy': 0.4272}
- weight_class:Heavyweight: {'rows': 94, 'accuracy': 0.3936}
- weight_class:Light Heavyweight: {'rows': 90, 'accuracy': 0.4889}
- weight_class:Lightweight: {'rows': 174, 'accuracy': 0.3966}
- weight_class:Middleweight: {'rows': 169, 'accuracy': 0.4556}
- weight_class:Welterweight: {'rows': 148, 'accuracy': 0.4257}
- weight_class:Women's Bantamweight: {'rows': 55, 'accuracy': 0.4364}
- weight_class:Women's Flyweight: {'rows': 62, 'accuracy': 0.4677}
- weight_class:Women's Strawweight: {'rows': 83, 'accuracy': 0.4699}
- enough_fighter_history: {'rows': 1091, 'accuracy': 0.4372}
- low_fighter_history: {'rows': 231, 'accuracy': 0.4935}
...
| fight_duration_model | >=80% | 1919 | 51.92 | 0.9276 | 0.927 | 0.9218 | -0.0058 | True | False |
...
| finish_in_round_1_model | >=80% | 302 | 8.2 | 0.851 | 0.7806 | 0.8519 | 0.0009 | True | False |
| finish_type_model | >=75% | 568 | 31.63 | 0.5951 | 0.5183 | 0.8544 | 0.2593 | False | False |
| method_umbrella_model | >=80% | 996 | 26.95 | 0.9137 | 0.4305 | 0.9165 | 0.0028 | True | False |
| strike_volume_model | >=80% | 55 | 4.16 | 0.6545 | 0.4444 | 0.849 | 0.1945 | False | False |
| takedown_control_model | >=80% | 217 | 8.73 | 0.7742 | 0.5178 | 0.8442 | 0.07 | False | False |
| finish_model | >=80% | 1919 | 51.92 | 0.9276 | 0.927 | 0.9218 | -0.0058 | True | False |
| goes_distance_model | >=80% | 1919 | 51.92 | 0.9276 | 0.927 | 0.9218 | -0.0058 | True | False |
...
| finish_type_model | 208 | 80 | 5 | selected |
...
| over_1_5_model | experimental | balanced_accuracy_not_dangerously_low, beats_chronological_baseline, calibration_acceptable, duplicate_mirrored_fight_leakage_prevented, high_confidence_not_tiny_sample_noise, interaction_final_test_not_used_for_selection, interaction_leakage_columns_excluded, runtime_feature_schema_exists | source_holdout_not_run | research only |
...
| finish_in_round_1_model | weak_or_failed_baseline | balanced_accuracy_not_dangerously_low, duplicate_mirrored_fight_leakage_prevented, high_confidence_not_tiny_sample_noise, interaction_final_test_not_used_for_selection, interaction_leakage_columns_excluded, interaction_runtime_parity_passes, runtime_feature_schema_exists | beats_chronological_baseline, calibration_acceptable, source_holdout_not_run | research only |
| finish_type_model | weak_or_failed_baseline | calibration_acceptable, duplicate_mirrored_fight_leakage_prevented, high_confidence_not_tiny_sample_noise, interaction_final_test_not_used_for_selection, interaction_leakage_columns_excluded, interaction_runtime_parity_passes, runtime_feature_schema_exists | balanced_accuracy_not_dangerously_low, beats_chronological_baseline, source_holdout_not_run | research only |
...
| strike_volume_model | experimental | beats_chronological_baseline, duplicate_mirrored_fight_leakage_prevented, interaction_final_test_not_used_for_selection, interaction_leakage_columns_excluded, interaction_runtime_parity_passes, runtime_feature_schema_exists | balanced_accuracy_not_dangerously_low, calibration_acceptable, high_confidence_not_tiny_sample_noise, source_holdout_not_run | research only |
| takedown_control_model | experimental | balanced_accuracy_not_dangerously_low, beats_chronological_baseline, duplicate_mirrored_fight_leakage_prevented, high_confidence_not_tiny_sample_noise, interaction_final_test_not_used_for_selection, interaction_leakage_columns_excluded, runtime_feature_schema_exists | calibration_acceptable, source_holdout_not_run | research only |
