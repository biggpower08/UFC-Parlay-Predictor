...
export default function App() {
  ...
  async function checkHealth() {
    try {
      ...
      setHealth({ ok: false });
      setMessage("Prediction engine is not connected. Start the backend, then retry.");
    }
  }
  ...
  async function searchFighters(slot, value) {
    ...
    try {
      ...
      setMessage("Search is waiting for the prediction engine to connect.");
    }
  }
...
function FighterInput({ label, value, onChange, suggestions, onPick }) {
  return (
